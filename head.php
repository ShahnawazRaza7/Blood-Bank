...
<body>
  <div class="header">
    <a href="home.php" class="logo" <?php if ($active == 'home') echo "class='logo2'"; ?>>Blood Bank </a> Maintain By PCST Group.
    <div class="header-right">
      <a href="Donate.php" <?php if ($active == 'donate') echo "class='act'"; ?>>Donate</a>
