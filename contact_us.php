        ...
        <form name="sentMessage"  method="post">
            <div class="control-group form-group">
                <div class="controls">
                    ...
                    <input type="text" class="form-control" id="name" name="fullname" required placeholder="Enter Your Name">
            ...
            <div class="control-group form-group">
                <div class="controls">
                    ...
                    <input type="tel" class="form-control" id="Contact" name="contactno"  required placeholder="Enter Your Contact No." >
                </div>
            </div>
            <div class="control-group form-group">
                <div class="controls">
            ...
            <div class="control-group form-group">
                <div class="controls">
                    <label>Message:</label>
                    <textarea rows="10" cols="100" class="form-control" id="message" name="message" required  maxlength="999" style="resize:none" placeholder="Enter Your Message Here"></textarea>
                </div>
            </div>
