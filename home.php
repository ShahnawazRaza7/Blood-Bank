  ...
  <div id="page-container" style="  position: relative;min-height: 84vh;   ">
    <div id="demo" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="image/updated_NewYear2022.webp" alt="image\Blood-facts_10-illustration-graphics__canteen.png" width="100%" height="500">
        </div>
    ...
    <div class="container">
      <div id="content-wrap" style="padding-bottom:75px;">
        <h1 style="text-align:center;font-size:45px;">Welcome to BloodBank</h1>
        <br>
        <div class="row">
          <div class="col-lg-4 mb-4">
            <div class="card">
              <h4 class="card-header card bg-info text-white">Near By Blood bank</h4>

              <li class="card-body overflow-auto" style="padding-left:2%;height:120px;text-align:left;">

                <a href="https://mahasbtc.org/index.php/blood-bank-data/">Find Blood bank</a>
              </li>
            </div>
          </div>
          <div class="col-lg-4 mb-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <img src="image/Screenshot_29-2-2024_212351_www.eraktkosh.in.jpeg" alt="blood Group " style="height:450px;">
          </div>
